...
- **المحتوى حسب نوع العلاقة**:
  * إذا كان النوع "أصدقاء": اجعل الأسئلة عامة، ممتعة، تكشف أسراراً خفيفة أو مواقف طريفة، مع إضافة لمسة خفيفة جداً من أسئلة الإعجاب أو الحب (مثل: مواصفات فتى/فتاة الأحلام، كراش الطفولة، رأيه في الحب، الخ). لا تجعلها رومانسية بحتة.
  * إذا كان النوع "مرتبطين": اجعل الأسئلة رومانسية جداً، عميقة، وتساعد على فهم الشخص الآخر بعمق وتقوية العلاقة واكتشاف جوانب جديدة في مشاعره.
